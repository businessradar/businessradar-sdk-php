 ...
 * }
 */
final class Portfolio implements BaseModel
{
    /** @use SdkModel<PortfolioShape> */
    use SdkModel;
    ...
    /**
     * `new Portfolio()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * Portfolio::with(externalID: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Portfolio)->withExternalID(...)->withName(...)
     * ```
     */
