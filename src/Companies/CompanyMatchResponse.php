...
use Businessradar\Companies\CompanyMatchResponse\IndustryCode;
 ...
 * classifications.
 *
 * @phpstan-import-type IndustryCodeShape from \Businessradar\Companies\CompanyMatchResponse\IndustryCode
 *
 * @phpstan-type CompanyMatchResponseShape = array{
 *   addressPlace: string,
 ...
 *   industryCodes: list<\Businessradar\Companies\CompanyMatchResponse\IndustryCode|IndustryCodeShape>,
 *   name: string,
 ...
 * }
 */
final class CompanyMatchResponse implements BaseModel
{
    /** @use SdkModel<CompanyMatchResponseShape> */
    use SdkModel;
    ...
    /**
     * `new CompanyMatchResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CompanyMatchResponse::with(
     *   addressPlace: ...,
     *   addressPostal: ...,
     *   addressRegion: ...,
     *   addressStreet: ...,
