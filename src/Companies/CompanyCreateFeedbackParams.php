 ...
 * is resolved.
 *
 * @see Businessradar\Services\CompaniesService::createFeedback()
 *
 * @phpstan-type CompanyCreateFeedbackParamsShape = array{
 *   company: string,
 ...
 * }
 */
final class CompanyCreateFeedbackParams implements BaseModel
{
    /** @use SdkModel<CompanyCreateFeedbackParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CompanyCreateFeedbackParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CompanyCreateFeedbackParams::with(company: ..., feedbackType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CompanyCreateFeedbackParams)->withCompany(...)->withFeedbackType(...)
     * ```
     */
