 ...
 *
 * @phpstan-type CompanyNewMissingCompanyInvestigationResponseShape = array{
 ...
 * }
 */
final class CompanyNewMissingCompanyInvestigationResponse implements BaseModel
{
    /** @use SdkModel<CompanyNewMissingCompanyInvestigationResponseShape> */
    use SdkModel;
    ...
    /**
     * `new CompanyNewMissingCompanyInvestigationResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CompanyNewMissingCompanyInvestigationResponse::with(
     *   companyExternalID: ...,
     *   country: ...,
     *   createdAt: ...,
     *   externalID: ...,
     ...
     *
     * ```
     * (new CompanyNewMissingCompanyInvestigationResponse)
